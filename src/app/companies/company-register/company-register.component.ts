...
export class CompanyRegisterComponent implements OnInit {
  ...
  register(company: NgForm) {
    if (company.value.name === '' || company.value.name === undefined || 
        (company.value.email) === '' || company.value.email === undefined ||
        company.value.password === '' || company.value.password === undefined ||
        company.value.cpassword === '' || company.value.cpassword === undefined) {
